function[err_ratio_vector, err_vector] = QB_RBKI_deflation(A, block_size, inner_block_size_factor, tol, target_rank, num_iters)
    [m, n] = size(A);
    A_cpy = A;
    ...
    for j = 1:ceil(target_rank / block_size)
        ...
        err_vector = [err_vector, rel_fro_err]; %#ok<AGROW>
